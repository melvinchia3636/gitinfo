                  ...
                  <div>
                    ...
                    <div>
                      {result.users.items.slice(0, 5).map((e) => (
                        <div className="flex items-center gap-4 py-2 border-b border-slate-50 px-2 hover:bg-purple-50 transition-all duration-200 rounded-md">
                  ...
                  <div>
                    ...
                    <div>
                      {result.repo.items.slice(0, 5).map((e) => (
                        <Link to={`/repo/${e.full_name}`} className="flex items-center gap-3 py-2 border-b border-slate-50 px-2 hover:bg-purple-50 transition-all duration-200 rounded-md">
