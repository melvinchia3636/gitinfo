...
function User() {
  ...
  return (
    data.length ? (
      <div className="pb-8">
        {data.map((e) => (
          <Link to={`/user/${e.login}`} className="py-4 px-2 flex border-b border-zinc-300 dark:border-zinc-600 gap-4 hover:bg-zinc-200 dark:hover:bg-zinc-500 duration-300 hover:rounded-md">
