        ...
        <ReactStickyBox>
          <div className="flex flex-col h-full gap-4 mb-4 text-zinc-600 dark:text-zinc-200 text-lg">
            {[
              ...
              <button onClick={() => setSection(index)} className={`flex items-center transition-all ${icon.startsWith('octicon') ? 'gap-[1.2rem]' : 'gap-4'} w-48 text-left px-4 py-2 pt-2.5 rounded-md ${section === index ? 'text-white bg-custom-500 shadow-md' : ''}`} type="button">
