...
function ReadmeMD({ data, setData }) {
  const fetchReadme = async () => {
    const README_URL = ['README.md', 'readme.md', 'README', 'Readme.md', '.github/README.md', 'README.markdown', 'Readme.markdown', 'readme.markdown', 'README.rst'].map((e) => `https://cors-anywhere.thecodeblog.net/raw.githubusercontent.com/${data.full_name}/${data.default_branch}/${e}`);
    let rmContent;
