...
function ReadmeMD({ data, setData }) {
  const fetchReadme = async () => {
    const README_URL = ['README.md', 'readme.md', '.github/README.md', 'README.rst'].map((e) => `https://cors-anywhere.thecodeblog.net/raw.githubusercontent.com/${data.full_name}/${data.default_branch}/${e}`);
    let rmContent;
