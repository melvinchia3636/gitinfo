...
function CloneCode({ data }) {
  ...
  return (
    <div className="px-1">
      ...
      />
      <div className={`w-[40vw] overscroll-contain absolute top-1/2 left-1/2 -translate-x-1/2 bg-zinc-50 shadow-2xl text-zinc-600 rounded-xl overflow-y-scroll p-6 flex flex-col gap-4 transform transition-all duration-500 ${cloneCodeBoxShow ? '-translate-y-1/2' : 'translate-y-[120%]'}`}>
        ...
        <code className="w-full bg-zinc-100 rounded-md shadow-md flex items-center justify-between p-3">
