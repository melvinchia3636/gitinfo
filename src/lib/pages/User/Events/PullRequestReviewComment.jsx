...
${e.payload.comment.diff_hunk}
  ...
  return (
    <div className="min-w-0">
      <div className="flex min-w-0 gap-2 text-xl overflow-hidden font-medium text-zinc-600 dark:text-zinc-200 tracking-wide">
      ...
      <div className="w-full border mt-4 rounded-md border-zinc-300 dark:border-zinc-600 shadow-sm p-4">
        ...
        <div className="flex items-center overflow-x-auto gap-2 mt-4 text-sm dark:text-zinc-200">
